            ...
            <section>
                ...
                <div className={styles.text_box}>
                    ...
                    <span>
                        ...
                        ...以上が私が用いる技術になります。<p></p>
                        HP制作ではGoogleでの検索順位が上位に入りやすくなるSPA(シングルページアプリケーション)技術を<p></p>
                        可能にするNext.jsフレームワークを使用し制作しております。<p></p>
                        また、現在もっとも普及しているとされてるREST APIよりも素早いサービス間通信が行える<p></p>
                        「gRPC」を用いたWebアプリケーション開発を行っております。<p></p>
                        私のこのポートフォリオサイトも「News」項目にあるブログ機能を実現するためgRPC通信を利用した<p></p>
                        軽量なマイクロサービスで構築致しました。
